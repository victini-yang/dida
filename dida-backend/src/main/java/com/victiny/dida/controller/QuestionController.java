...
import com.victiny.dida.config.VipSchedulerConfig;
...
import com.victiny.dida.model.dto.question.*;
...
import com.victiny.dida.model.enums.AppTypeEnum;
...
public class QuestionController {
    ...
    private String getGenerateQuestionUserMessage(App app, int questionNumber, int optionNumber) {
        String userMessageTemplate = "应用名称：%s\n" +
                "应用描述：%s\n" +
                "应用类别：%s\n" +
                "要生成的题目数：%d\n" +
                "每个题目的选项数：%d";
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerateQuestion(
        ...
        // AI 生成
        String result = aiManager.doSyncRequest(GENERATE_QUESTION_SYSTEM_MESSAGE, userMessage, 0.05f);
        // 截取需要的 JSON 信息
    ...
    public SseEmitter aiGenerateQuestionSSE(AiGenerateQuestionRequest aiGenerateQuestionRequest,HttpServletRequest request) {
        ...
        // AI 生成，SSE 流式返回
        Flowable<ModelData> modelDataFlowable = aiManager.doStreamRequest(GENERATE_QUESTION_SYSTEM_MESSAGE, userMessage, 0.99f);
